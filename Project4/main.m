...
exportgraphics(gca, 'Images/body_fixed_pos.png','Resolution',300)
...
exportgraphics(gca, 'Images/body_fixed_vel.png','Resolution',300)
...
% Plotting trajectory individually vs time
figure;
ax1 = subplot(3, 1, 1);
hold on
plot(ax1, t, x_obsv)
scatter(ax1, tmeas, x_meas)
hold off
ylabel('x(t) (km)')
...
% Calculating mean and covariance of estimates from montecarlo runs
...
% Plotting Covariances along the y-z
